...
//     const toggleAutoPrint = () => setPaymentConfig({...paymentConfig, autoPrint: !paymentConfig.autoPrint});

//     const handleSave = () => {
//         // Trong thực tế sẽ gọi API lưu settings
//         alert("Đã lưu cấu hình hệ thống thành công! ✅");
//     };

//     const handleBackup = () => {
//         alert("Đang tạo file sao lưu... Tải xuống thành công! 📦");
//     };

//     const handleReset = () => {
//         if(window.confirm("CẢNH BÁO: Hành động này sẽ xóa toàn bộ dữ liệu bán hàng hôm nay. Bạn có chắc không?")) {
//             alert("Đã reset dữ liệu ca làm việc hiện tại.");
//         }
//     };
...
//                 <button onClick={handleSave} className="bg-accent text-white text-sm px-6 py-2 rounded-lg hover:brightness-110 shadow-lg font-bold animate-pulse">
//                     Lưu thay đổi
//                 </button>
//             </div>
...
//                         <div>
//                             <label className="text-xs text-text-dim block mb-1">Tên cửa hàng</label>
...
//                         </div>
//                         <div>
//                             <label className="text-xs text-text-dim block mb-1">Địa chỉ (In trên bill)</label>
...
//                         </div>
//                         <div>
//                             <label className="text-xs text-text-dim block mb-1">Lời chào cuối hóa đơn</label>
//                             <textarea name="welcome" value={storeInfo.welcome} onChange={handleChangeStore} className="w-full bg-bg border border-[#444] rounded-lg p-3 text-white focus:border-accent outline-none h-[80px]" />
//                         </div>
//                     </div>
//                 </div>
...
//                             <div className="grid grid-cols-2 gap-4">
//                                 <div>
//                                     <label className="text-xs text-text-dim block mb-1">Ngân hàng</label>
...
//                                 </div>
//                                 <div>
//                                     <label className="text-xs text-text-dim block mb-1">Số tài khoản</label>
...
//                             </div>
//                             <div>
//                                 <label className="text-xs text-text-dim block mb-1">Tên chủ tài khoản</label>
//                                 <input name="accountName" value={paymentConfig.accountName} onChange={handleChangePayment} className="w-full bg-bg border border-[#444] rounded-lg p-3 text-white outline-none uppercase" />
//                             </div>
//                             <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg border border-white/5">
//                                 <div>
//                                     <div className="text-white font-bold text-sm">Thuế VAT (%)</div>
//                                     <div className="text-xs text-text-dim">Áp dụng cho tất cả đơn hàng</div>
//                                 </div>
...
//                     {/* 3. MÁY IN & HỆ THỐNG */}
//                     <div className="bg-surface p-6 rounded-2xl border border-white/5 flex-1">
//                         <h3 className="text-white font-bold mb-4 text-sm uppercase tracking-wider flex items-center gap-2">
//                             🖨️ Máy in & Dữ liệu
//                         </h3>
//                         <div className="space-y-4">
...
//                                     <button onClick={() => setPrinterConfig({...printerConfig, paperSize: '58mm'})} className={`px-3 py-1 rounded text-xs font-bold border ${printerConfig.paperSize === '58mm' ? 'bg-accent text-white border-accent' : 'border-[#444] text-text-dim'}`}>58mm</button>
//                                     <button onClick={() => setPrinterConfig({...printerConfig, paperSize: '80mm'})} className={`px-3 py-1 rounded text-xs font-bold border ${printerConfig.paperSize === '80mm' ? 'bg-accent text-white border-accent' : 'border-[#444] text-text-dim'}`}>80mm (Chuẩn)</button>
//                                 </div>
//                             </div>
                            
//                             <div className="flex justify-between items-center pt-2">
//                                 <span className="text-text-dim text-sm">Tự động in sau khi thanh toán</span>
//                                 <div onClick={toggleAutoPrint} className={`w-10 h-5 rounded-full cursor-pointer relative transition-colors ${paymentConfig.autoPrint ? 'bg-success' : 'bg-[#444]'}`}>
//                                     <div className={`w-3 h-3 bg-white rounded-full absolute top-1 transition-all ${paymentConfig.autoPrint ? 'left-6' : 'left-1'}`}></div>
//                                 </div>
//                             </div>

//                             <div className="pt-4 mt-4 border-t border-white/10 flex gap-3">
//                                 <button onClick={handleBackup} className="flex-1 py-3 bg-blue-500/20 text-blue-400 hover:bg-blue-500/30 rounded-lg text-sm font-bold border border-blue-500/30">
//                                     ☁️ Sao lưu dữ liệu
//                                 </button>
//                                 <button onClick={handleReset} className="flex-1 py-3 bg-danger/20 text-danger hover:bg-danger/30 rounded-lg text-sm font-bold border border-danger/30">
//                                     🗑️ Reset Hệ thống
//                                 </button>
//                             </div>
//                         </div>
