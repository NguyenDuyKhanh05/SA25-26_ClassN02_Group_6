...
const SystemSettings = () => {
  ...
  const saveToLocal = () => {
    localStorage.setItem('shop_config', JSON.stringify(shopConfig));
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input name="phone" type="text" value={shopConfig.phone} onChange={handleUpdateConfig} className="w-full bg-[#252525] border border-[#444] rounded-lg p-2.5 text-white outline-none focus:border-[#d4a373]" />
              </div>
              <div>
